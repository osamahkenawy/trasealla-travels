...
import { dataTable, hiddenTableRecords, loadingTableRecords, searchTableRecords, sortingTableRecords } from '../../../../../data/other';
...
const Hidden = ({
  ...
  return <>
      <Card>
        ...
        <CardBody>
          <div className="py-3">
            <Grid data={hiddenTableRecoard} pagination={{
            limit: 5
          }} sort />
          </div>
        </CardBody>
...
const Loading = ({
  ...
  return <>
      <Card>
        ...
        <CardBody>
          <Grid data={loadingTableRecords} pagination={{
          limit: 5
        }} sort />
        </CardBody>
      </Card>
...
const Sorting = ({
  ...
  return <>
      <Card>
        ...
        <CardBody>
          <Grid data={sortingTableRecords} pagination={{
          limit: 5
        }} sort />
        </CardBody>
      </Card>
...
const Search = ({
  ...
  return <>
      <Card>
        ...
        <CardBody>
          <Grid data={searchTableRecords} pagination={{
          limit: 5
        }} search={true} />
        </CardBody>
      </Card>
...
const Pagination = ({
  ...
  return <>
      <Card>
        ...
        <CardBody>
          <Grid data={dataTable} pagination={{
          limit: 5
        }} />
        </CardBody>
      </Card>
